...
import entry48 from "./catalog/cloudflare-bindings.json" with { type: "json" };
import entry49 from "./catalog/cloudflare-browser-rendering.json" with { type: "json" };
import entry50 from "./catalog/cloudflare-builds.json" with { type: "json" };
import entry51 from "./catalog/cloudflare-docs.json" with { type: "json" };
import entry52 from "./catalog/cloudflare-observability.json" with { type: "json" };
import entry53 from "./catalog/deepwiki.json" with { type: "json" };
import entry54 from "./catalog/everything.json" with { type: "json" };
import entry55 from "./catalog/exa.json" with { type: "json" };
import entry56 from "./catalog/fetch.json" with { type: "json" };
import entry57 from "./catalog/filesystem.json" with { type: "json" };
import entry58 from "./catalog/firecrawl.json" with { type: "json" };
import entry59 from "./catalog/git.json" with { type: "json" };
import entry60 from "./catalog/huggingface.json" with { type: "json" };
import entry61 from "./catalog/kagi.json" with { type: "json" };
import entry62 from "./catalog/memory.json" with { type: "json" };
import entry63 from "./catalog/mongodb.json" with { type: "json" };
import entry64 from "./catalog/neon.json" with { type: "json" };
import entry65 from "./catalog/obsidian.json" with { type: "json" };
import entry66 from "./catalog/paypal.json" with { type: "json" };
import entry67 from "./catalog/playwright.json" with { type: "json" };
